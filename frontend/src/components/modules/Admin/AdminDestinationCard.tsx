...
import { HideIcon, ViewIcon } from "../../../../public/svgs/icons";

const AdminDestinationCard: React.FC<CardProps> = ({
  countryName,
  cityName,
  depatureDate,
  returnDate,
  ...
  return (
    <div className=" w-[400px] rounded-lg border border-gray-400 bg-white shadow-md">
      ...
      <div className="p-3">
        <div className="flex flex-row">
          ...
          <p className="black-light-font mt-2">
        ...
        <div className="p-2">
          ...
          <div className="mb-1">
            {!isExpanded && (
              <div className="light-font text-left  ">
          ...
          <div className="flex flex-row justify-between">
            <div className="text-2xl font-bold secondary_text_color mt-2 ">
              &#8358;{price}
            </div>
            <Button
              children={"View Particpants"}
              className="button_bg rounded-md mt-3 text-white font-bold text-sm"
            />
          </div>
          ...
          <div className="flex flex-row justify-between">
            <div className="flex flex-row gap-3">
              ...
              <Image width={20} height={0} src="/svgs/edit.svg" alt="delete" />
            </div>
            {isPublished ? (
              <Button
                children={"Unpublish"}
                icon={<HideIcon />}
                iconPosition="end"
                className="rounded-md mt-3 primary_text_color border border-gray-300 font-bold flex flex-row gap-4"
